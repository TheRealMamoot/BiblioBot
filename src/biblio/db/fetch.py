...
async def fetch_all_reservations() -> DataFrame:
    ...
    notified,
    processed_at AT TIME ZONE 'Europe/Rome' as processed_at,
    success_at AT TIME ZONE 'Europe/Rome' as success_at,
    fail_at AT TIME ZONE 'Europe/Rome' as fail_at,
    terminated_at AT TIME ZONE 'Europe/Rome' as terminated_at,
    canceled_at AT TIME ZONE 'Europe/Rome' as canceled_at,
