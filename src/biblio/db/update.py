...
async def update_cancel_status(reservation_id: str, db_env='staging') -> None:
...
async def update_record(table: str, row_id: str, updates: dict[str, Any], db_env='staging') -> None:
    if not updates:
