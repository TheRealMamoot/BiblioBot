...
async def test_single_record_retry_delay(mock_update, mock_confirm, mock_set_reservation):
    ...
    for attempt in range(20):
        ...
        duration = end - start
        print(f'Attempt {attempt} → Retry {retries} | Timeout.read = {timeout.read:.1f}s | Took ≈ {duration:.2f}s')
